...
const artworkData = [
    ...
    /*
    {
        ...
        medium: 'Oil on Wood Panel',
        year: 2024,
        image: artThumbnails[16],
        placeholder: artPlaceholderImages[16],
        images: [
            artZoomImages[16]
        ],
        placeholders: [
